...
TRPO Results
"""
trpo_1 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Hopper/exp_1/progress.csv")
trpo_2 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Hopper/exp_2/progress.csv")
trpo_3 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Hopper/exp_3/progress.csv")
trpo_4 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Hopper/exp_4/progress.csv")
trpo_5 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Hopper/exp_5/progress.csv")
...
np.save('./Result_Arrays/trpo_hopper.npy', trpo_episode_reward)
...
PPO Results
"""
ppo_1 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Hopper/exp_1/progress.csv")
ppo_2 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Hopper/exp_2/progress.csv")
ppo_3 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Hopper/exp_3/progress.csv")
ppo_4 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Hopper/exp_4/progress.csv")
ppo_5 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Hopper/exp_5/progress.csv")
...
np.save('./Result_Arrays/ppo_hopper.npy', ppo_episode_reward)


"""
DDPG Results
"""
ddpg_episode_reward = np.load('/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baselines_ddpg_results/Results/Hopper_Policy_Activation_Relu_all_exp_rewards.npy')
...
np.save('./Result_Arrays/ddpg_hopper.npy', mean_ddpg_episode_reward)
...
acktr_1 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Hopper/exp_1/progress.csv")
acktr_2 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Hopper/exp_2/progress.csv")
acktr_3 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Hopper/exp_3/progress.csv")
acktr_4 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Hopper/exp_4/progress.csv")
acktr_5 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Hopper/exp_5/progress.csv")


acktr_1_episode_reward = np.array(acktr_1["EpRewMean"])
acktr_1_episode_reward = acktr_1_episode_reward[0:705]
acktr_2_episode_reward = np.array(acktr_2["EpRewMean"])
acktr_2_episode_reward = acktr_2_episode_reward[0:705]
acktr_3_episode_reward = np.array(acktr_3["EpRewMean"])
acktr_3_episode_reward = acktr_3_episode_reward[0:705]
acktr_4_episode_reward = np.array(acktr_4["EpRewMean"])
acktr_4_episode_reward = acktr_4_episode_reward[0:705]
acktr_5_episode_reward = np.array(acktr_5["EpRewMean"])
acktr_5_episode_reward = acktr_5_episode_reward[0:705]
...
acktr_time_steps = np.arange(0, 2e6, 2500)
acktr_time_steps = acktr_time_steps[0:705]
...
np.save('./Result_Arrays/acktr_hopper.npy', acktr_episode_reward)
...
#     plt.title("Hopper Environment", fontsize=30)
  
#     plt.show()
  
#     fig.savefig('Hopper_Env_Algos.png')
...
def double_plot(stats1, stats2, stats3, stats4, smoothing_window=1, noshow=False):
    ...
    plt.title("Hopper Environment", **axis_font)
