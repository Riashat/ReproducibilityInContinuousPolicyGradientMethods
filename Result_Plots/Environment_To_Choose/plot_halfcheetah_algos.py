...
#TRPO average return
np.save('./Result_Arrays/trpo_halfcheetah.npy', trpo_episode_reward)
...
np.save('./Result_Arrays/ppo_halfcheetah.npy', ppo_episode_reward)
...
np.save('./Result_Arrays/ddpg_halfcheetah.npy', ddpg_episode_reward)
...
np.save('./Result_Arrays/acktr_halfcheetah.npy', acktr_episode_reward)
