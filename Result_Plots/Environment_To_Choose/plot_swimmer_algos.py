...
TRPO Results
"""
trpo_1 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Swimmer/exp_1/progress.csv")
trpo_2 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Swimmer/exp_2/progress.csv")
trpo_3 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Swimmer/exp_3/progress.csv")
trpo_4 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Swimmer/exp_4/progress.csv")
trpo_5 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_trpo_results/Env_Choose/Swimmer/exp_5/progress.csv")
...
np.save('./Result_Arrays/trpo_swimmer.npy', trpo_episode_reward)
...
PPO Results
"""
ppo_1 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Swimmer/exp_1/progress.csv")
ppo_2 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Swimmer/exp_2/progress.csv")
ppo_3 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Swimmer/exp_3/progress.csv")
ppo_4 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Swimmer/exp_4/progress.csv")
ppo_5 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_ppo_results/Env_Choose/Swimmer/exp_5/progress.csv")
...
np.save('./Result_Arrays/ppo_swimmer.npy', ppo_episode_reward)

"""
DDPG Results
"""
ddpg_episode_reward = np.load('/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baselines_ddpg_results/Results/Env_Exp_DDPG_Swimmer_all_exp_rewards.npy')
...
np.save('./Result_Arrays/ddpg_swimmer.npy', ddpg_episode_reward)
...
acktr_1 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Swimmer/exp_1/progress.csv")
acktr_2 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Swimmer/exp_2/progress.csv")
acktr_3 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Swimmer/exp_3/progress.csv")
acktr_4 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Swimmer/exp_4/progress.csv")
acktr_5 = pd.read_csv("/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baseline_acktr_results/Env_Choose/Swimmer/exp_5/progress.csv")
...
np.save('./Result_Arrays/acktr_swimmer.npy', acktr_episode_reward)
...
#     plt.title("Swimmer Environment", fontsize=30)
  
#     plt.show()

#     fig.savefig('Swimmer_Env_Algos.png')
...
def double_plot(stats1, stats2, stats3, stats4, smoothing_window=1, noshow=False):
    ...
    plt.title("Swimmer Environment", **axis_font)
