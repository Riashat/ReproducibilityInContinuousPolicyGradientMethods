...
#HalfCheetah Policy Size
hs_400_300 = np.load('/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baselines_ddpg_results/Results/HalfCheetah_Policy_Size_400_300_all_exp_rewards.npy')
...
hs_100_50 = np.load('/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baselines_ddpg_results/Results/HalfCheetah_Policy_Activation_100_50_all_exp_rewards.npy')
...
ho_100_50 = np.load('/Users/Riashat/Documents/PhD_Research/OpenAIBaselines/ReproducibilityML/Results/rllab_results/baselines_ddpg_results/Results/Hopper_Policy_Size_100_50_all_exp_rewards.npy')
...
#     cum_rwd_1, = plt.plot(eps, rewards_smoothed_1, color = "red", linewidth=2.5, label="Actor Network Size = 64 x 64")    
...
#     cum_rwd_2, = plt.plot(eps, rewards_smoothed_2, color = "blue", linewidth=2.5, label="Actor Network Size = 100 x 50 x 25" )  
...
#     cum_rwd_3, = plt.plot(eps, rewards_smoothed_3, color = "black", linewidth=2.5, label="Actor Network Size = 400 x 300" )  
...
#     plt.title("DDPG with HalfCheetah Environment, Actor Network Size", fontsize=30)
  
#     plt.show()
    
#     fig.savefig('ddpg_halfcheetah_policy_size.png')
#     return fig
...
def halfcheetah_plot(stats1, stats2, stats3,  smoothing_window=5, noshow=False):
    ...
    cum_rwd_1, = plt.plot(eps, rewards_smoothed_1, color = "#1f77b4", linewidth=2.5, label="Actor Network Size = 64 x 64")    
    ...
    cum_rwd_2, = plt.plot(eps, rewards_smoothed_2, color = "#ff7f0e", linewidth=2.5, label="Actor Network Size = 100 x 50 x 25" )  
    ...
    cum_rwd_3, = plt.plot(eps, rewards_smoothed_3, color = "#d62728", linewidth=2.5, label="Actor Network Size = 400 x 300" )  
    ...
    plt.title("DDPG with HalfCheetah Environment, Actor Network Size", **axis_font)
...
def hopper_plot(stats1, stats2, stats3,  smoothing_window=5, noshow=False):
    ...
    plt.xlabel("Timesteps", **axis_font)
    plt.ylabel("Average Returns", **axis_font)
    plt.title("DDPG with Hopper Environment, Actor Network Size", **axis_font)
  
    plt.show()
    
    fig.savefig('ddpg_hopper_policy_size.png')
    return fig
