...
def run(env_id, seed, noise_type, num_cpu, layer_norm, activation, network_size, logdir, gym_monitor, evaluation, bind_to_core, **kwargs):
    ...
    ### ACTOR and CRITIC networks/modules here
    critic = Critic(layer_norm=layer_norm, activation=activation, network_size=network_size)
    actor = Actor(nb_actions, layer_norm=layer_norm, activation=activation, network_size=network_size)
    ...
    #### training.py - for training actor and critic networks in ddpg
    training.train(env=env, eval_env=eval_env, param_noise=param_noise,
        action_noise=action_noise, actor=actor, critic=critic, memory=memory, environment_name=environment_name,  **kwargs)
